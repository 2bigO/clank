...
- `qwopus-pi`
  ...
  - context/offload: `--ctx-size 262144`, `--gpu-layers -1` so llama.cpp fit can choose partial ROCm offload
...
- Qwopus must not force full GPU offload; `--gpu-layers -1` lets llama.cpp fit choose a safe partial ROCm offload at native context
